...
clientPokemon.moveTrack;_i14<_clientPokemon$moveTr2.length;_i14++){var _ref2=_clientPokemon$moveTr2[_i14];var _moveName=_ref2[0];{
...
text+="<p class=\"tooltip-section\">";for(var _i16=0,_clientPokemon$moveTr4=
clientPokemon.moveTrack;_i16<_clientPokemon$moveTr4.length;_i16++){var _row=_clientPokemon$moveTr4[_i16];
...
var atLeastOne=false;for(var _i18=0,_this$battle$sides4=
this.battle.sides;_i18<_this$battle$sides4.length;_i18++){var side=_this$battle$sides4[_i18];
...
if(side.battle.speciesClause)return false;for(var _i20=0,_side$pokemon4=
side.pokemon;_i20<_side$pokemon4.length;_i20++){var ally=_side$pokemon4[_i20];
...
var pokemon=clientPokemon||serverPokemon;
var isPowerTrick=clientPokemon==null?void 0:clientPokemon.volatiles['powertrick'];for(var _i22=0,_Dex$statNamesExceptH2=
Dex.statNamesExceptHP;_i22<_Dex$statNamesExceptH2.length;_i22++){var statName=_Dex$statNamesExceptH2[_i22];
...
if(this.battle.gen<=1){for(var _i24=0,_Dex$statNamesExceptH4=
Dex.statNamesExceptHP;_i24<_Dex$statNamesExceptH4.length;_i24++){var _statName=_Dex$statNamesExceptH4[_i24];
...
stats.spa=Math.floor(stats.spa*1.5);
}for(var _i32=0,_Dex$statNamesExceptH8=
Dex.statNamesExceptHP;_i32<_Dex$statNamesExceptH8.length;_i32++){var _statName3=_Dex$statNamesExceptH8[_i32];
...
var chainedSpeedModifier=1;for(var _i34=0;_i34<
speedModifiers.length;_i34++){var modifier=speedModifiers[_i34];
...
if(!short){
var hasModifiedStat=false;for(var _i36=0,_Dex$statNamesExceptH10=
Dex.statNamesExceptHP;_i36<_Dex$statNamesExceptH10.length;_i36++){var statName=_Dex$statNamesExceptH10[_i36];
...
buf+='<p>';
}for(var _i38=0,_Dex$statNamesExceptH12=

Dex.statNamesExceptHP;_i38<_Dex$statNamesExceptH12.length;_i38++){var _statName4=_Dex$statNamesExceptH12[_i38];
...
ppUsed=function ppUsed(move,pokemon){for(var _i40=0,_pokemon$moveTrack2=
pokemon.moveTrack;_i40<_pokemon$moveTrack2.length;_i40++){var _ref4=_pokemon$moveTrack2[_i40];var moveName=_ref4[0];var _ppUsed=_ref4[1];
...
}for(var _i42=0,_pokemon$side$active2=

pokemon.side.active;_i42<_pokemon$side$active2.length;_i42++){var active=_pokemon$side$active2[_i42];
...
var chain=4096;for(var _i44=0;_i44<
accuracyModifiers.length;_i44++){var mod=accuracyModifiers[_i44];
if(mod!==4096){
...
var boostCount=0;for(var _i46=0,_Object$values2=
Object.values(target.boosts);_i46<_Object$values2.length;_i46++){var boost=_Object$values2[_i46];
...
var _boostCount=0;for(var _i48=0,_Object$values4=
Object.values(pokemon.boosts);_i48<_Object$values4.length;_i48++){var _boost=_Object$values4[_i48];
...
if(move.category!=='Status'){
var auraBoosted='';
var auraBroken=false;for(var _i50=0,_pokemon$side$active4=
pokemon.side.active;_i50<_pokemon$side$active4.length;_i50++){var ally=_pokemon$side$active4[_i50];
if(!ally||ally.fainted)continue;
var allyAbility=this.getAllyAbility(ally);
...
}for(var _i52=0,_pokemon$side$foe$act2=
pokemon.side.foe.active;_i52<_pokemon$side$foe$act2.length;_i52++){var foe=_pokemon$side$foe$act2[_i52];
...
var _boostCount2=0;for(var _i54=0,_Object$values6=
Object.values(pokemon.boosts);_i54<_Object$values6.length;_i54++){var _boost2=_Object$values6[_i54];
...
for(var _i55=1;_i55<=5&&_i55<=pokemon.side.faintCounter;_i55++){
if(pokemon.volatiles["fallen"+_i55]){
value.abilityModify([1,1.15,1.3,1.45,1.6,1.75][_i55],"Hardcore Hustle");
}
}
...
for(var _i56=1;_i56<=5&&_i56<=pokemon.side.faintCounter;_i56++){
if(pokemon.volatiles["fallen"+_i56]){
value.abilityModify(1+0.05*_i56,"The Eminence in the Shadow");
}
}
}
...
if(!types)types=this.getPokemonTypes(pokemon);for(var _i58=0,_types2=
types;_i58<_types2.length;_i58++){var curType=_types2[_i58];
...
if(fusionSpecies.exists&&fusionSpecies.name!==species.name){for(var _i60=0,_Object$values8=
Object.values(fusionSpecies.abilities);_i60<_Object$values8.length;_i60++){var newAbility=_Object$values8[_i60];
...
var origLeftoverEVs=508;for(var _i62=0,_Dex$statNames2=
Dex.statNames;_i62<_Dex$statNames2.length;_i62++){var _origSpread$evs;var stat=_Dex$statNames2[_i62];
...
if(!minusTooLow){for(var _i64=0,_Dex$statNamesExceptH14=
Dex.statNamesExceptHP;_i64<_Dex$statNamesExceptH14.length;_i64++){var _stat=_Dex$statNamesExceptH14[_i64];
...
if(!plusTooHigh){for(var _i66=0,_Dex$statNamesExceptH16=
Dex.statNamesExceptHP;_i66<_Dex$statNamesExceptH16.length;_i66++){var _stat2=_Dex$statNamesExceptH16[_i66];
...
}for(var _i68=0,_Dex$statNames4=
Dex.statNames;_i68<_Dex$statNames4.length;_i68++){var _stat3=_Dex$statNames4[_i68];
...
if(savedEVs<0)return null;for(var _i70=0,_Dex$statNames6=
Dex.statNames;_i70<_Dex$statNames6.length;_i70++){var _stat4=_Dex$statNames6[_i70];
