...
destroy=function destroy(){var _this$sprite;
(_this$sprite=this.sprite)==null||_this$sprite.destroy();
this.sprite=null;
this.side=null;
};return Pokemon;}();var
...
function Side(battle,n){this.battle=void 0;this.name='';this.id='';this.sideid=void 0;this.n=void 0;this.isFar=void 0;this.foe=null;this.ally=null;this.avatar='unknown';this.badges=[];this.rating='';this.totalPokemon=6;this.x=0;this.y=0;this.z=0;this.missedPokemon=null;this.wisher=null;this.active=[null];this.lastPokemon=null;this.pokemon=[];this.openTeamSheet=false;this.sideConditions={};this.faintCounter=0;
this.battle=battle;
this.n=n;
...
pokemon.clearVolatile();
if(effect.id==='shedtail'){var _pokemon$sprite;
pokemon.volatiles={substitute:['substitute']};
(_pokemon$sprite=pokemon.sprite)==null||_pokemon$sprite.animSub(true);
}
}else{
...
_effect15.id!=='futuresight'&&_effect15.id!=='doomdesire'){
